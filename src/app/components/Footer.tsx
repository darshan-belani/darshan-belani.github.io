        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <Image src="/logo.png" alt="Logo" width={40} height={40} style={{ objectFit: 'cover', display: 'block', width: '80%', height: '80%', marginBottom: '4px' }} />
            </div>
            <div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem' }}>{personalInfo.fullName}</div>
              <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Full Stack Developer</div>
            </div>
          </div>

          {/* Center */}
          <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem', textAlign: 'center' }}>
            <span>© {year} {personalInfo.fullName}. All rights reserved.</span>
          </div>
